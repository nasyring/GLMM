...
\NormalTok{standardized\_conditional\_residuals }\OtherTok{\textless{}{-}}\NormalTok{ cholP2}\SpecialCharTok{\%*\%}\NormalTok{(Y }\SpecialCharTok{{-}}\NormalTok{ Loblolly}\SpecialCharTok{$}\NormalTok{fitted4)}
