...
\FunctionTok{plot}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{Seed, standardized\_resids, }\AttributeTok{xlab =} \StringTok{\textquotesingle{}Seed\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}standardized marginal residual\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cholP2 }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{chol}\NormalTok{(}\FunctionTok{solve}\NormalTok{(P2)))}
