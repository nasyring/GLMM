...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(lme4)}
\NormalTok{model3lmer }\OtherTok{\textless{}{-}} \FunctionTok{lmer}\NormalTok{(height }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(age,}\DecValTok{5}\NormalTok{) }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{|}\NormalTok{ Seed), }\AttributeTok{data =}\NormalTok{ Loblolly, }\AttributeTok{control =} \FunctionTok{lmerControl}\NormalTok{(}\AttributeTok{optimizer=}\StringTok{"Nelder\_Mead"}\NormalTok{, }\AttributeTok{optCtrl =} \FunctionTok{list}\NormalTok{(}\AttributeTok{maxfun =} \DecValTok{100000}\NormalTok{), }\AttributeTok{check.conv.grad =} \FunctionTok{.makeCC}\NormalTok{(}\StringTok{"warning"}\NormalTok{, }\AttributeTok{tol =} \FloatTok{0.71}\NormalTok{, }\AttributeTok{relTol =} \ConstantTok{NULL}\NormalTok{)))}
\NormalTok{marginal.resids3 }\OtherTok{\textless{}{-}}\NormalTok{ Loblolly}\SpecialCharTok{$}\NormalTok{height }\SpecialCharTok{{-}} \FunctionTok{model.matrix}\NormalTok{(model3lmer, }\AttributeTok{type =} \StringTok{\textquotesingle{}fixed\textquotesingle{}}\NormalTok{)}\SpecialCharTok{\%*\%}\FunctionTok{fixef}\NormalTok{(model3lmer)}
\FunctionTok{plot}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{age, marginal.resids3, }\AttributeTok{xlab =} \StringTok{\textquotesingle{}age\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}marginal residual\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Loblolly}\SpecialCharTok{$}\NormalTok{fitted3 }\OtherTok{\textless{}{-}} \FunctionTok{fitted}\NormalTok{(model3lmer)}
...
\includegraphics{GLMM_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model4lmer }\OtherTok{\textless{}{-}} \FunctionTok{lmer}\NormalTok{(height }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(age,}\DecValTok{5}\NormalTok{) }\SpecialCharTok{+}\NormalTok{ (}\FunctionTok{poly}\NormalTok{(age,}\DecValTok{2}\NormalTok{) }\SpecialCharTok{|}\NormalTok{ Seed), }\AttributeTok{data =}\NormalTok{ Loblolly)}
\NormalTok{marginal.resids4 }\OtherTok{\textless{}{-}}\NormalTok{ Loblolly}\SpecialCharTok{$}\NormalTok{height }\SpecialCharTok{{-}} \FunctionTok{model.matrix}\NormalTok{(model4lmer, }\AttributeTok{type =} \StringTok{\textquotesingle{}fixed\textquotesingle{}}\NormalTok{)}\SpecialCharTok{\%*\%}\FunctionTok{fixef}\NormalTok{(model4lmer)}
\NormalTok{Loblolly}\SpecialCharTok{$}\NormalTok{fitted4 }\OtherTok{\textless{}{-}} \FunctionTok{fitted}\NormalTok{(model4lmer)}
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ Loblolly) }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ age, }\AttributeTok{y =}\NormalTok{ height)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ age, }\AttributeTok{y =}\NormalTok{ height)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ age, }\AttributeTok{y =}\NormalTok{ fitted4, }\AttributeTok{color =} \StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ Seed, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{GLMM_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Z }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(model4lmer, }\AttributeTok{type =} \StringTok{\textquotesingle{}random\textquotesingle{}}\NormalTok{)}
\NormalTok{dim\_cov }\OtherTok{\textless{}{-}} \FunctionTok{dim}\NormalTok{(}\FunctionTok{attr}\NormalTok{(}\FunctionTok{VarCorr}\NormalTok{(model4lmer)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{$}\NormalTok{Seed, }\StringTok{\textquotesingle{}correlation\textquotesingle{}}\NormalTok{))[}\DecValTok{1}\NormalTok{]}
\NormalTok{psi\_i }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(}\FunctionTok{VarCorr}\NormalTok{(model4lmer)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{$}\NormalTok{Seed[}\DecValTok{1}\SpecialCharTok{:}\NormalTok{dim\_cov,}\DecValTok{1}\SpecialCharTok{:}\NormalTok{dim\_cov])}
\NormalTok{psi }\OtherTok{\textless{}{-}} \FunctionTok{bdiag\_m}\NormalTok{(}\FunctionTok{list}\NormalTok{(psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i,psi\_i))}
\NormalTok{inv\_psi }\OtherTok{\textless{}{-}} \FunctionTok{solve}\NormalTok{(psi)}
\NormalTok{L }\OtherTok{\textless{}{-}}\NormalTok{ (}\FunctionTok{summary}\NormalTok{(model4lmer)}\SpecialCharTok{$}\NormalTok{sigma}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{diag}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(Loblolly))}
\NormalTok{invL }\OtherTok{\textless{}{-}} \FunctionTok{solve}\NormalTok{(L)}
\NormalTok{A }\OtherTok{\textless{}{-}}\NormalTok{ inv\_psi}\SpecialCharTok{+}\FunctionTok{t}\NormalTok{(Z)}\SpecialCharTok{\%*\%}\NormalTok{invL}\SpecialCharTok{\%*\%}\NormalTok{Z}
\NormalTok{invA }\OtherTok{\textless{}{-}} \FunctionTok{solve}\NormalTok{(A)}
\NormalTok{P}\OtherTok{\textless{}{-}}\NormalTok{invL}\SpecialCharTok{{-}}\NormalTok{invL}\SpecialCharTok{\%*\%}\NormalTok{Z}\SpecialCharTok{\%*\%}\NormalTok{invA}\SpecialCharTok{\%*\%}\FunctionTok{t}\NormalTok{(Z)}\SpecialCharTok{\%*\%}\NormalTok{invL}
\NormalTok{X }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(}\FunctionTok{model.matrix}\NormalTok{(model4lmer, }\AttributeTok{type =} \StringTok{\textquotesingle{}fixed\textquotesingle{}}\NormalTok{))}
\NormalTok{cov.beta.hat }\OtherTok{\textless{}{-}} \FunctionTok{solve}\NormalTok{(}\FunctionTok{t}\NormalTok{(X)}\SpecialCharTok{\%*\%}\NormalTok{P}\SpecialCharTok{\%*\%}\NormalTok{X)}
\NormalTok{Sigma\_e }\OtherTok{\textless{}{-}}\NormalTok{ P}\SpecialCharTok{{-}}\NormalTok{X}\SpecialCharTok{\%*\%}\NormalTok{cov.beta.hat}\SpecialCharTok{\%*\%}\FunctionTok{t}\NormalTok{(X)}
\NormalTok{Y }\OtherTok{\textless{}{-}}\NormalTok{ Loblolly}\SpecialCharTok{$}\NormalTok{height}
\NormalTok{beta.hat }\OtherTok{\textless{}{-}}\NormalTok{ cov.beta.hat}\SpecialCharTok{\%*\%}\FunctionTok{t}\NormalTok{(X)}\SpecialCharTok{\%*\%}\NormalTok{P}\SpecialCharTok{\%*\%}\NormalTok{Y}
...
\NormalTok{cholPi }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{solve}\NormalTok{(}\FunctionTok{chol}\NormalTok{(}\FunctionTok{solve}\NormalTok{(Pi))))}
...
\NormalTok{cov.check }\OtherTok{\textless{}{-}} \DecValTok{0}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{14}\NormalTok{)\{}
\NormalTok{  standardized\_resids[(seed}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\DecValTok{6}\SpecialCharTok{+}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{)] }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(cholPi)}\SpecialCharTok{\%*\%}\NormalTok{marginal.resids4[(seed}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\DecValTok{6}\SpecialCharTok{+}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{)]}
\NormalTok{  cov.check }\OtherTok{\textless{}{-}}\NormalTok{ cov.check }\SpecialCharTok{+} \FunctionTok{sum}\NormalTok{((}\FunctionTok{diag}\NormalTok{(}\DecValTok{6}\NormalTok{)}\SpecialCharTok{{-}}\NormalTok{standardized\_resids[(seed}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\DecValTok{6}\SpecialCharTok{+}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{)]}\SpecialCharTok{\%*\%}\FunctionTok{t}\NormalTok{(standardized\_resids[(seed}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\DecValTok{6}\SpecialCharTok{+}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{)]))}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{  seed }\OtherTok{\textless{}{-}}\NormalTok{ seed }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}

\NormalTok{Loblolly}\SpecialCharTok{$}\NormalTok{standardized\_resids }\OtherTok{\textless{}{-}}\NormalTok{ standardized\_resids}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Loblolly}\OtherTok{\textless{}{-}}\NormalTok{Loblolly }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(Seed) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{sd\_stan\_resids =} \FunctionTok{sd}\NormalTok{(standardized\_resids)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{arrange}\NormalTok{(sd\_stan\_resids) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{()}

\NormalTok{Loblolly}\SpecialCharTok{$}\NormalTok{Seed }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{Seed, }\AttributeTok{ordered =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{levels =} \FunctionTok{unique}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{Seed))}

\FunctionTok{plot}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{Seed, Loblolly}\SpecialCharTok{$}\NormalTok{standardized\_resids, }\AttributeTok{xlab =} \StringTok{\textquotesingle{}Seed\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}standardized marginal residual\textquotesingle{}}\NormalTok{, }\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{6}\NormalTok{,}\DecValTok{6}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{GLMM_files/figure-latex/unnamed-chunk-19-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fakedata }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{84}\NormalTok{), }\FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{6}\NormalTok{),}
                                \FunctionTok{rep}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{7}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{8}\NormalTok{,}\DecValTok{6}\NormalTok{),}
                                \FunctionTok{rep}\NormalTok{(}\DecValTok{9}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{11}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{12}\NormalTok{,}\DecValTok{6}\NormalTok{),}
                                \FunctionTok{rep}\NormalTok{(}\DecValTok{13}\NormalTok{,}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\DecValTok{14}\NormalTok{,}\DecValTok{6}\NormalTok{)))}

\NormalTok{fakedata }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(fakedata)}

\NormalTok{fakedata}\OtherTok{\textless{}{-}}\NormalTok{fakedata }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(X2) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{sd\_X1 =} \FunctionTok{sd}\NormalTok{(X1)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{arrange}\NormalTok{(sd\_X1) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{()}

\NormalTok{fakedata}\SpecialCharTok{$}\NormalTok{X2 }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(fakedata}\SpecialCharTok{$}\NormalTok{X2, }\AttributeTok{ordered =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{levels =} \FunctionTok{unique}\NormalTok{(fakedata}\SpecialCharTok{$}\NormalTok{X2))}

\FunctionTok{plot}\NormalTok{(fakedata}\SpecialCharTok{$}\NormalTok{X2, fakedata}\SpecialCharTok{$}\NormalTok{X1, }\AttributeTok{xlab =} \StringTok{\textquotesingle{}random normals\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}sample standard deviation\textquotesingle{}}\NormalTok{, }\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{6}\NormalTok{,}\DecValTok{6}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{GLMM_files/figure-latex/unnamed-chunk-19-2.pdf}
...
\begin{Highlighting}[]
\NormalTok{model4lmer }\OtherTok{\textless{}{-}} \FunctionTok{lmer}\NormalTok{(height }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(age,}\DecValTok{5}\NormalTok{) }\SpecialCharTok{+}\NormalTok{ (}\FunctionTok{poly}\NormalTok{(age,}\DecValTok{2}\NormalTok{) }\SpecialCharTok{|}\NormalTok{ Seed), }\AttributeTok{data =}\NormalTok{ Loblolly)}
\NormalTok{B }\OtherTok{\textless{}{-}}\NormalTok{ (}\FunctionTok{diag}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(Loblolly)) }\SpecialCharTok{{-}}\NormalTok{ Z}\SpecialCharTok{\%*\%}\NormalTok{invA}\SpecialCharTok{\%*\%}\FunctionTok{t}\NormalTok{(Z)}\SpecialCharTok{\%*\%}\NormalTok{invL)}
\NormalTok{P2 }\OtherTok{\textless{}{-}}\NormalTok{ B}\SpecialCharTok{\%*\%}\FunctionTok{solve}\NormalTok{(P)}\SpecialCharTok{\%*\%}\FunctionTok{t}\NormalTok{(B)}
\NormalTok{cholP2 }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{solve}\NormalTok{(}\FunctionTok{chol}\NormalTok{(P2)))}
\NormalTok{standardized\_conditional\_residuals }\OtherTok{\textless{}{-}}\NormalTok{ cholP2}\SpecialCharTok{\%*\%}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{height }\SpecialCharTok{{-}} \FunctionTok{fitted}\NormalTok{(model4lmer))}
\FunctionTok{qqnorm}\NormalTok{(standardized\_conditional\_residuals)}
\FunctionTok{qqline}\NormalTok{(standardized\_conditional\_residuals)}
\end{Highlighting}
\end{Shaded}

\includegraphics{GLMM_files/figure-latex/unnamed-chunk-20-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Loblolly}\SpecialCharTok{$}\NormalTok{standardized\_conditional\_residuals }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(standardized\_conditional\_residuals)}
\FunctionTok{boxplot}\NormalTok{(standardized\_conditional\_residuals}\SpecialCharTok{\textasciitilde{}}\NormalTok{Seed, }\AttributeTok{data =}\NormalTok{ Loblolly,}\AttributeTok{xlab =} \StringTok{\textquotesingle{}Seed\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}standardized conditional residual\textquotesingle{}}\NormalTok{, }\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{GLMM_files/figure-latex/unnamed-chunk-20-2.pdf}
...
\includegraphics{GLMM_files/figure-latex/unnamed-chunk-20-3.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X5 }\OtherTok{\textless{}{-}} \FunctionTok{poly}\NormalTok{(Loblolly}\SpecialCharTok{$}\NormalTok{age,}\DecValTok{5}\NormalTok{)}
\NormalTok{Loblolly\_poly }\OtherTok{\textless{}{-}}\NormalTok{ Loblolly}
\NormalTok{Loblolly\_poly}\SpecialCharTok{$}\NormalTok{linear }\OtherTok{\textless{}{-}}\NormalTok{ X5[,}\DecValTok{1}\NormalTok{]}
\NormalTok{Loblolly\_poly}\SpecialCharTok{$}\NormalTok{quadratic }\OtherTok{\textless{}{-}}\NormalTok{ X5[,}\DecValTok{2}\NormalTok{]}
\NormalTok{Loblolly\_poly}\SpecialCharTok{$}\NormalTok{cubic }\OtherTok{\textless{}{-}}\NormalTok{ X5[,}\DecValTok{3}\NormalTok{]}
\NormalTok{Loblolly\_poly}\SpecialCharTok{$}\NormalTok{quartic }\OtherTok{\textless{}{-}}\NormalTok{ X5[,}\DecValTok{4}\NormalTok{]}
\NormalTok{Loblolly\_poly}\SpecialCharTok{$}\NormalTok{quintic }\OtherTok{\textless{}{-}}\NormalTok{ X5[,}\DecValTok{5}\NormalTok{]}
\NormalTok{model2lmer\_quartic }\OtherTok{\textless{}{-}} \FunctionTok{lmer}\NormalTok{(height }\SpecialCharTok{\textasciitilde{}}\NormalTok{ linear}\SpecialCharTok{+}\NormalTok{quadratic}\SpecialCharTok{+}\NormalTok{cubic}\SpecialCharTok{+}\NormalTok{quartic }\SpecialCharTok{+}\NormalTok{ (linear}\SpecialCharTok{+}\NormalTok{quadratic }\SpecialCharTok{|}\NormalTok{ Seed), }\AttributeTok{data =}\NormalTok{ Loblolly\_poly)}
\FunctionTok{summary}\NormalTok{(model2lmer\_quartic)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{booted }\OtherTok{\textless{}{-}} \FunctionTok{bootMer}\NormalTok{(model2lmer\_quintic, fun, }\DecValTok{100}\NormalTok{, }\AttributeTok{type =} \StringTok{\textquotesingle{}parametric\textquotesingle{}}\NormalTok{)}
