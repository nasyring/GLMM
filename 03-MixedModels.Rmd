...
<br><br>
In fact, this alternative WLS estimator in \@ref(eq:WLS1) is equivalent to the estimator in \@ref(eq:WLS2), which can be shown by a straightforward (but tedious) calculation confirming   
...
### Asymptotic Distribution of Fixed Effects MLE
